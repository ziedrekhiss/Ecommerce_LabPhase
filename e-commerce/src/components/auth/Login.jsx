...
export default function Login() {
    ...
    useEffect(() => {
        ...
        if (auth.isLogged && auth.role == 'user') {
          navigate('/home'); // Redirect to the homepage
        } else if (auth.error !==''){setError(auth.error)}
    ...
    <div className="login">
        ...
        <div className="input-box">
            <input
                ...
                onChange={(e)=>setIdentifiers({...identifiers, email:e.target.value})} 
            />
            <AiOutlineUser/>
        </div>
        <div className="input-box">
            <input 
                ...
                onChange={(e)=>setIdentifiers({...identifiers, password: e.target.value})}
                />
            <AiOutlineLock/>
        </div>
